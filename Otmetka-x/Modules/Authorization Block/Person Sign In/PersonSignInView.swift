...
protocol PersonSignInViewControllerDelegate: AnyObject {
    func update(with state: TableViewModelState)
    func didCatchError(with text: String)
    func toggleButton(with flag: Bool)
}

final class PersonSignInViewController: BaseViewController, PersonSignInViewControllerDelegate {
    
    // Dependencies
    var presenter: PersonSignInPresenterProtocol!
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = R.string.localizable.signInPersonTitleLabelText()
...
extension PersonSignInViewController {
